...
class Clock_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Clock', // Name
			[ 'description' => __( 'Clock Widget', 'wpadvancedtheme' ) ] // Args
		);
	}
	/**
	...
	public function widget( $args, $instance ) {
        ...
        <!-- jQuery code to display the clock data is in assets/js/main.js -->
		<section class="card">
